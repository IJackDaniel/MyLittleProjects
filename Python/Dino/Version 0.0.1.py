...
is_jump = False
jump = 15
jump_height = 15  # Нужен для ограничений и не изменяется. Обязательно равен значению jump
...
obstacles_height = [80, 100, 120, 130, 150]
obstacles_y = [580, 550, 530, 520, 500]
...
while not done:
    ...
    if not end:
        ...
        # Столкновение
        if 50 <= x1 + ob_h <= 200 and y + 150 > ob_y:
            end = True
